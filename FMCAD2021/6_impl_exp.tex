...
The experiment results are summarized in Table~\ref{table:arithmetic}-\ref{table:string}, where ``Fail'' means either timeout, unknown, or wrong answers. 
...
\begin{table}[ht]
    ...
    \hline
        ...
        \cline{2-10}
         ...
         \cline{1-10}
        \multirow{3}{*}{Flat} 
         & S & 34 & 19.0 & 88 & 12.7 & 5 & {\bf \textless{}0.1}& 115  & 12.3\\
        \cline{2-10}
         & U & 0 & - & 1 & 4.0 & 182 & 2.5 & 182 & 47.7 \\
         \cline{2-10}
         & F & 266 & - & 211 & - & 113 & - & 3 & - \\ \hline
         \cline{1-10}
        \multirow{3}{*}{Non-flat}
