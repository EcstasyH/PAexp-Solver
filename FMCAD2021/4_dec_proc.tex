...
\label{thm-paexp}
{\paexp} admits quantifier elimination\wuhao{ in triply exponential deterministic time and space}. 
\end{theorem}
%
...
Moreover, we give a complexity analysis in Appendix~\ref{app:cpx}.% which was missing in \cite{Point86}.
%
%
