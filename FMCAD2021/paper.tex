...
%    Besides the theoretical results, we also develop various optimizations and provide an implementation.
    ...
    %for string-integer conversion as well as linear-exponential constraints.
