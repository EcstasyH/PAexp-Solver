...
%
We also analyze the deterministic upper bound of the  complexity is triply exponential for the first time (Appendix~\ref{app:cpx}). \wuhao{Since the best known upper bound for Cooper's elimination algorithm is also triply exponential, it may not be easy to improve the bound. }
