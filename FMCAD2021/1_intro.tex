...
One more recent approach is flattening~\cite{}.
...
Second, and more importantly, because we can convert the membership problem of a flat automaton to a satisfiability problem of Presburgh formula, the class of word equation + regular constraints + length constraints is decidable.
...
We propose a decision procedure for the class of word equation + regular constraints + length constraints + string/number conversion under arbitrary flat automata.
