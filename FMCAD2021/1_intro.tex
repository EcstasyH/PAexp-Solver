...
In fact, other than the theoretical difficulties, in practice, the string-number constraints are quite challenging for state-of-the-art solvers. 
...
\yfc{todo: a short description of optimizations}
