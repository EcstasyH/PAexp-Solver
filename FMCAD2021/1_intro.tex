...
\wuhao{We also analyze the deterministic upper bound of the complexity for the first time, the time complexity of eliminating one quantifier is shown to be triply exponential (Appendix~\ref{app:cpx}).} 
